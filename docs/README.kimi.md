...
2. Loads only the workflow-choice notice through `systemPromptPath`. It does not load a skill at session start. Suggest relevant workflows and invoke them only after request or acceptance.
