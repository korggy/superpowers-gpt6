...
matching_plugins = [plugin for plugin in plugins if plugin.get("name") == "superpowers-gpt6"]
assert_equal(len(matching_plugins), 1, "superpowers-gpt6 plugin entry count")
